...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="user/login" class="logo">豬豬在線 <span class="lite">管理者後台</span></a>
      <!--logo end-->
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">ppo@gs.amfc.com.tw</span>
                            <b class="caret"></b>
                        </a>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="active" href="basic_table.html">管理債權</a></li>
              <li><a class="active" href="basic_table.html">管理帳務</a></li>
            </ul>
          </li>
          <li>
            ...
            <div id="search_panel" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
              <div class="panel-body">
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-4'>
                    <form novalidate="novalidate" class="simple_form new_loan" id="new_loan" action="/admin/loans" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="9R7xkIYgsZmWtueWfsXsBQHyutqHcmzGMSdET2r6nUHlPair49mLURMEfeazmvTuAELZrap4h5YMKp8/v/DKZQ==" />
                      <select name="loan_type" class="select optional form-control select2 filter-loan_type" include_blank="true" id="loan_loan_type"><option value=""></option>
      <option value="0">個人信用貸款</option>
      <option value="1">個⼈抵押貸(車貸)</option>
      <option value="2">個⼈抵押貸(房子)</option>
      <option value="3">商業貸</option></select>
      </form>            </div>
                  <div class="clear"></div>
                </div>
