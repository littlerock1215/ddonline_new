...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="/admin" class="logo">豬豬在線 <span class="lite">管理者後台</span></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="active" href="/admin/claims">管理債權</a></li>
              <li><a class="active" href="/admin/claim_repayments">管理帳務</a></li>
            </ul>
          </li>
          <li>
