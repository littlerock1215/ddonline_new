...
<div id="main-page">
        ...
        <link rel="stylesheet" media="screen" href="template/modal/modal.css" />
        <link rel="stylesheet" media="screen" href="template/css/sliderbar.css" />
        <link rel="stylesheet" media="screen" href="template/table/css/table.css" />
        <link rel="stylesheet" media="screen" href="template/css/goodpopup.min.css?v=2018091701" />
        ...
        <div id="banner-box">
          <div class="banner-list">
            ...
            <li style="background: url('template/banner/img/1.jpg') ; background-attachment: fixed;">
                  ...
                  <div class="row con60 cob60">
                      <div style=" width: 100%">
                          <div class="col-md-7">
                              ...
                              <div aos="fade-up" aos-duration="1000" class="aos-init"> <img src="template/images/txt1.png" alt="" style="width:100%"></div>
                              <div aos="fade-up" aos-duration="1500" class="aos-init"> <img src="template/images/txt2.png" alt="" style="width:100%"></div>
                              <div aos="fade-up" aos-duration="2000" class="aos-init"> <img src="template/images/txt3.png" alt="" style="width:100%"></div>
                          </div>
                      </div>
                  </div>
                </div>
        ...
        <section class="service_jpg22">
            <div class="container">
                <div class="row con60">
                    ...
                    <div>
                        <img src="template/images/s1.png" width="100%"  class="m1">   
                        <img src="template/images/s_img.png" width="100%" style="display:none;" class="m2">            
                    </div>                      
        ...
        <section class="service_jpg2_b" style="background: url(template/images/banner_a.jpg)">
              ...
              <div class="modal-content">
                <div class="mobg">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="modal-img"><img src="template/images/t3.png" alt=""></div>
                    <div class="modal-all-p">
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-sm-6 col-12 modal-title">
                            ...
                            <div><img src="template/images/t1.png" alt="" style="width:100%"></div>
                        </div>
                        <div class="col-sm-6 col-12 modal-title">
                          <div class="modal-title-d">行為信用評分(Behavior Score)</div>
                          <div><img src="template/images/t2.png" alt="" style="width:100%"></div>
                        </div>
                      </div>
                    </div>
                    <div class="modal-all-p">
              ...
              <div class="modal-content  ">
                <div class="mobg3">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="modal-all-p">
                      <div class="modal-f1">
                        <img src="template/images/index_open.png" alt="" width="100%">
                        <div class="" style="width: 100%;text-align: center;">
                          <img src="template/images/scroll.png" alt="">
                        </div>
                        <div class="index-modal-open">
                          <div class="open2"><img src="template/images/index_open2.png" alt=""></div>
                          <div class="indext20">
                            <div class="f23m">智能媒合項目</div>
                            <div class="index-3">
                              <div class="heblock">
                                <img src="template/images/n1.png" alt="" width="22" class="igpd">
                              </div>
                              <span class="fos">完成註冊登入會員</span>
                            </div>
                            <div class="index-3">
                              <div class="heblock">
                                <img src="template/images/n2.png" alt="" width="22" class="igpd">
                              </div>
                            ...
                            <div class="index-3">
                              <div class="heblock">
                                <img src="template/images/n3.png" alt="" width="22" class="igpd">
                              </div>
                            ...
                            <div class="index-3">
                              <div class="heblock">
                                <img src="template/images/n4.png" alt="" width="22" class="igpd">
                              </div>
                            ...
                            <div class="index-3">
                              <div class="heblock">
                                <img src="template/images/n5.png" alt="" width="22" class="igpd">
                              </div>
                            ...
                            <div class="index-3">
                              <div class="heblock">
                                <img src="template/images/n6.png" alt="" width="22" class="igpd">
                              </div>
                            ...
                            <div class="index-3">
                              <div class="heblock">
                                <img src="template/images/n7.png" alt="" width="22" class="igpd">
                              </div>
                            ...
                            <div class="index-3">
                              <div class="heblock">
                                <img src="template/images/n8.png" alt="" width="22" class="igpd">
                              </div>
                        ...
                        <div class="index-modal-open">
                          <div class="open2"><img src="template/images/index_open3.png" alt=""></div>
                          <div class="indext20">
        ...
        <section>
          ...
          <script id="demo-popup-1" type="text/x-handlebars-template">
            ...
            <div class="container">
                <div class="hl4">
                    ...
                    <img src="template/images/step1.png" width="90"></div>
                    請輸入您的投資金額
          ...
          <script id="demo-popup-2" type="text/x-handlebars-template">
            ...
            <div class="form">
                ...
                <img src="template/images/step2.png" width="90"></div>
        ...
        <script type="text/javascript">
          ...
          <script id="demo-popup-3" type="text/x-handlebars-template">
            ...
            <div class="" style="text-align: center;padding-bottom: 20px;width: 100%;margin-top: 10px;"><img src="template/images/step3.png" width="90">
