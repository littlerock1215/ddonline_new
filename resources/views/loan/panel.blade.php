...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="btauto m-auto ">
      <!-- Large modal -->
      <button type="button" id="loan_form_button" class="btn btbt3">貸款申請</button>
      <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="loan_form">
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <form class="nifty_form" id="new_loan" action="/front" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="v98xaqJKZA7dbDLtYgBUnvWhyfiag/3RRdLFKyhl9fCCuOfGyQ33Nf9KH71+1azFFhOdCkGKRNm4cgY+dm8qyA==" />
              <div class="modal-body"> 
                  ...
                  <div id="mySpecialElements">
                    ...
                    <!-- <div id="npup0_1" class="loan_select_area hidden">
                    </div> -->
...
<input type="text" name="captcha" id="captcha" autocomplete="off" autocorrect="off" autocapitalize="off" required="required" placeholder="" /><input type="hidden" name="captcha_key" id="simple-captcha-hidden-field-simple_captcha-27f582115cb" value="27f582115cb3874f452d7ea3911a19e1b8e3b203" />
</div>
